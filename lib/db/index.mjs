 ...
 */
/**
 * RASTLA'nın varsayılan komisyon payı, on binde. 1800 = %18.
 *
 * schema.sql'deki DEFAULT ile aynı değer olmalı; burada sabit olarak duruyor
 * çünkü hem sütun göçü hem de eski varsayılanı taşıyan kayıtların yükseltilmesi
 * bu değere bakıyor.
 */
const COMMISSION_BP = 1800;

/** Bu değerde kalmış kayıtlar "hiç belirlenmemiş" sayılır. */
const PREVIOUS_COMMISSION_BP = 1000;
