...
Bunların hepsi **gerçek bir veritabanına** yazıyor (SQLite ya da Postgres, tek bir bağlantı dizesiyle seçilir) ve doğruluk iddiaları 25 süitle, ayrı işletim sistemi süreçleriyle, iki motorda birden sınanıyor.
